...
<div class="page-header">
    ...
    @if ($alertsCount > 0)
        <span class="status-chip danger">{{ $alertsCount }} <span data-i18n="Alerts need action">Alerts need action</span></span>
    @else
...
<section>
    <div class="section-header">
        ...
        @if ($alertsCount > 0)
            <span class="status-chip danger">{{ $alertsCount }} <span data-i18n="cases">cases</span></span>
        @else
